...
**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/nhatpse/Antigravity-MCP/v1.3.1/install.ps1 | iex
```

**Linux / macOS:**
```bash
curl -fsSL https://raw.githubusercontent.com/nhatpse/Antigravity-MCP/v1.3.1/install.sh | bash
```
